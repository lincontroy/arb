            ...
            <div class="row gy-5">
                <div class="col-lg-8 pe-lg-4">
                    <div class="blog-detials mb-60">
                        <div class="image">
                            <img src="<?php echo e(displayImage(getArrayValue($content?->meta, 'main_image'), '1200x500')); ?>" alt="<?php echo e(__('Blog Details Image')); ?>">
                        </div>
                        <ul class="meta-list">
                            <li><a href="javascript:void(0)"><i class="bi bi-calendar2"></i><?php echo e(showDateTime($content?->created_at)); ?></a></li>
                        </ul>
                        <div class="title">
                            <h3><?php echo e(getArrayValue($content?->meta, 'title')); ?></h3>
                        </div>
                        <?php echo getArrayValue($content?->meta, 'description') ?>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="sidebar-widget">
                        ...
                        <?php $__currentLoopData = $recentPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recentPost): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="news-item">
                                <h6>
                                    <a href="<?php echo e(route('blog.detail', $recentPost->id)); ?>" data-cursor="View"><?php echo e(getArrayValue($recentPost->meta, 'title')); ?></a>
                                </h6>
                                <span class="time">
...
<?php echo $__env->make(getActiveTheme().'.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampppp\htdocs\arb\src\resources\views/default_theme/blog_detail.blade.php ENDPATH**/ ?>