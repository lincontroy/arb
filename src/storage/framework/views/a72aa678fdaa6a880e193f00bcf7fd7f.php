            ...
            <div class="modal-content">
                ...
                <form method="POST" action="<?php echo e(route('user.matrix.store')); ?>">
                    ...
                    <div class="modal-body">
                        <p><?php echo e(__("Are you sure you want to enroll in this matrix scheme?")); ?></p>
                    </div>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampppp\htdocs\arb\src\resources\views/user/matrix/index.blade.php ENDPATH**/ ?>