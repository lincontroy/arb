            ...
            <div class="pricing-item style-two">
                ...
                <div class="header">
                    ...
                    <div class="d-flex justify-content-between flex-wrap align-items-center gap-2">
                        <p class="text-start fs-16 mb-0"><?php echo e(__('Interest Rate')); ?>: <span class="text-white"> <?php echo e(shortAmount($investment->interest_rate)); ?><?php echo e(\App\Enums\Investment\InterestType::getSymbol($investment->interest_type)); ?> </span></p>
...
<?php /**PATH C:\xampppp\htdocs\arb\src\resources\views/user/partials/investment/plan.blade.php ENDPATH**/ ?>