...
<?php $__currentLoopData = $matrix; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
        <div class="pricing-item card-style">
            ...
            <?php endif; ?>
            <div class="icon">
                <img src="<?php echo e(displayImage(getArrayValue($fixedContent?->meta, 'award_image'))); ?>" alt="<?php echo e(__('Award Image')); ?>" border="0">
            </div>
            <div class="header">
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH C:\xampppp\htdocs\arb\src\resources\views/user/partials/matrix/plan.blade.php ENDPATH**/ ?>