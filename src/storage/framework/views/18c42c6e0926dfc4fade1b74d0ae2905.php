...
<div class="banner-section">
    <div class="banner-bg">
        <img src="<?php echo e(displayImage(getArrayValue($fixedContent->meta, 'background_image'), '2470x1529')); ?>" alt="<?php echo e(__('Background Image')); ?>">
    </div>
        ...
        <div class="row align-items-center gy-5">
            <div class="col-lg-7">
                <div class="banner-content">
                    <h1><?php echo e(__(getArrayValue($fixedContent?->meta, 'heading'))); ?></h1>
                    ...
                    <div class="d-flex justify-content-between align-items-end gap-lg-4 gap-2">
                        <div class="d-flex justify-content-start align-items-center flex-lg-nowrap flex-wrap-reverse gap-4">
                            <a href="<?php echo e(__(getArrayValue($fixedContent?->meta, 'btn_url'))); ?> " class="i-btn banner-btn"><?php echo e(__(getArrayValue($fixedContent?->meta, 'btn_name'))); ?> <i class="bi bi-arrow-right-short"></i></a>
                            <div class="video-pluse">
                                <span></span>
                                <span></span>
                                <span></span>
                                <a data-fancybox href="<?php echo e(getArrayValue($fixedContent?->meta, 'video_link')); ?>"><i class="bi bi-play-fill"></i></a>
                            </div>
                        </div>
                        <div class="global-users">
                            ...
                            <div class="text">
                                <p><?php echo e(__(getArrayValue($fixedContent?->meta, 'first_text'))); ?></p>
                                <p><?php echo e(__(getArrayValue($fixedContent?->meta, 'second_text'))); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                <ul class="banner-features mb-60">
                    <li><span><?php echo getArrayValue($fixedContent?->meta, 'first_icon') ?></span><?php echo e(__(getArrayValue($fixedContent?->meta, 'first_title'))); ?></li>
                    <li><span><?php echo getArrayValue($fixedContent?->meta, 'second_icon') ?></span><?php echo e(__(getArrayValue($fixedContent?->meta, 'second_title'))); ?></li>
                    <li><span><?php echo getArrayValue($fixedContent?->meta, 'third_icon') ?></span><?php echo e(__(getArrayValue($fixedContent?->meta, 'third_title'))); ?></li>
                </ul>
...
<?php /**PATH C:\xampppp\htdocs\arb\src\resources\views/default_theme/component/banner.blade.php ENDPATH**/ ?>