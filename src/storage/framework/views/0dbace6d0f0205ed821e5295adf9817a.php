<?php
    $cookie = \App\Services\FrontendService::getFrontendContent(\App\Enums\Frontend\SectionKey::COOKIE, \App\Enums\Frontend\Content::FIXED);
?>

<div class="cookie d-none">
    <div class="cookie-content">
        <div class="cookie-icon">
            <svg id="fi_2561499" enable-background="new 0 0 512 512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                <g>
                    <path
        ...
        <p><?php echo e(__(getArrayValue($cookie->meta, 'title'))); ?></p>
    </div>

    <div class="cookie-action">
        <button class="i-btn btn--primary btn--lg capsuled accept-all"><?php echo e(__('Accept All')); ?></button>
    </div>
</div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampppp\htdocs\arb\src\resources\views/default_theme/partials/cookie.blade.php ENDPATH**/ ?>