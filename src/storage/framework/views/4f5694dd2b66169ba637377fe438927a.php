<?php if($hoory->status == \App\Enums\Status::ACTIVE): ?>
    <script>
        ...
        (function(d,t) {
            ...
            g.onload=function(){
                window.hoorySDK.run({
                    websiteToken: <?php echo e(getArrayValue($hoory?->short_key, 'api_key')); ?>,
                    baseUrl: BASE_URL
                })
            }
        })(document,"script");
    </script>
<?php endif; ?><?php /**PATH C:\xampppp\htdocs\arb\src\resources\views/partials/hoory.blade.php ENDPATH**/ ?>