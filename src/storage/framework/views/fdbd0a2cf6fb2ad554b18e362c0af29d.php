    ...
    <div class="responsive-table">
        <table>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                    $color = $name = $user = $fromUser = $plan = $parameter = $route = $withdrawGateway = $withdrawFinalAmount = $withdrawConversion = $withdrawRate = $withdrawLimit = $withdrawCharges = '';
                    ...
                    <?php $__currentLoopData = $columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dbColumn => $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td data-label="<?php echo e($column); ?>">
                            ...
                            <?php elseif($dbColumn == 'payment_gateway_name'): ?>
                                <div  class="d-flex justify-content-sm-start justify-content-end align-items-center gap-2">
                                    <div class="crypto-currency-icon">
                                        <img src="<?php echo e(displayImage($row->file, '400x400')); ?>"  alt="<?php echo e($row->name); ?>">
                                    </div>
                                    <span class="flex-shrink-0"><?php echo e($row->name); ?></span>
                                </div>
                            ...
                            <?php elseif(Str::contains($dbColumn, "crypto")): ?>
                                <?php if($dbColumn == 'crypto_price_change_24h'): ?>
                                    <span><?php echo e(getArrayValue($row->meta, Str::replaceFirst('crypto_', '', $dbColumn))); ?>%</span>
                                <?php else: ?>
                                    <span><?php echo e(getCurrencySymbol()); ?><?php echo e(getArrayValue($row->meta, Str::replaceFirst('crypto_', '', $dbColumn))); ?></span>
                                <?php endif; ?>
                            ...
                            <?php elseif($dbColumn == 'withdraw_amount'): ?>
                                <span><?php echo e($withdrawFinalAmount); ?></span>
                            ...
                            <?php elseif($dbColumn == 'amount' || $dbColumn == 'reward' || $dbColumn == 'referral_reward' || $dbColumn == 'profit' || $dbColumn == 'minimum' || $dbColumn == 'maximum'
                            ...
                            <?php elseif($dbColumn == 'priority'): ?>
                                <span class="badge <?php echo e(\App\Enums\TicketPriorityStatus::getColor($row->$dbColumn)); ?>"><?php echo e(\App\Enums\TicketPriorityStatus::getColor($row->$dbColumn)); ?></span>
                            ...
                            <?php elseif($dbColumn == 'language_action'): ?>
                                <div class="d-flex align-items-center justify-content-md-start justify-content-end gap-1">
                                    <a href="javascript:void(0)" class="badge badge--primary-transparent languageUpdateBtn"
                                       ...
                                       data-is_default="<?php echo e($row->is_default); ?>"
                                    ><?php echo e(__('Edit')); ?></a>
                                    ...
                                    <a href="<?php echo e(route('admin.language.edit', $row->id)); ?>"
                                       class="badge badge--success-transparent menuDeleteBtn"> <?php echo e(__('Translate')); ?>
                                ...
                                <div class="d-flex align-items-center justify-content-md-start justify-content-end gap-1">
                                    <?php if(!$row->is_default): ?>
                                        ...
                                        <a href="javascript:void(0)"
                                           data-id="<?php echo e($row->id); ?>"
                                           class="badge badge--danger-transparent menuDeleteBtn"> <?php echo e(__('Delete')); ?>
                            ...
                            <?php elseif($dbColumn == 'user_kyc_status'): ?>
                                <span class="badge <?php echo e(\App\Enums\User\KycStatus::getColor($row->kyc_status)); ?>"><?php echo e(\App\Enums\User\KycStatus::getName($row->kyc_status)); ?></span>
...
<?php /**PATH C:\xampppp\htdocs\arb\src\resources\views/admin/partials/table.blade.php ENDPATH**/ ?>