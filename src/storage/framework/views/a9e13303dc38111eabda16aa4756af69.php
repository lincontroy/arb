                            ...
                            <?php $__currentLoopData = $enhancementContents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $enhancementContent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="swiper-slide">
                                    <div class="blog-item-two">
                                        <div class="image">
                                            <img src="<?php echo e(displayImage(getArrayValue($enhancementContent->meta, 'thumb_image'), '800x500')); ?>" alt="<?php echo e(__('thumb Image')); ?>">
                                            <div class="date">
                                        ...
                                        <div class="content">
                                            <h4 class="card--title">
                                                <a href="<?php echo e(route('blog.detail', $enhancementContent->id)); ?>" data-cursor="View Details"><?php echo e(getArrayValue($enhancementContent->meta, 'title')); ?></a>
                                            </h4>
...
<?php /**PATH C:\xampppp\htdocs\arb\src\resources\views/default_theme/component/blog.blade.php ENDPATH**/ ?>